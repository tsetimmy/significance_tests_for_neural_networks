...
B = estimate_Bsquare()
get_test_results(trials, limiting_distribution, B=B.mean(), sieve_rate=True, d=8.)
get_test_results(trials, limiting_distribution, B=B.mean(), sieve_rate=False, d=8.)
get_test_results(trials, limiting_distribution, B=np.max(B), sieve_rate=True, d=8.)
get_test_results(trials, limiting_distribution, B=np.max(B), sieve_rate=False, d=8.)
